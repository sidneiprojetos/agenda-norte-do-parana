...
export const DivisionManagerModal: FC<DivisionManagerModalProps> = ({
  ...
  const content = (
    <div className="flex flex-col gap-4">
      ...
      <div className={`flex items-center justify-between ${embedded ? '' : 'border-t border-zinc-800 pt-4'}`}>
  ...
  return embedded ? (
    <div className="rounded-2xl border border-zinc-800 bg-zinc-900/60 p-4">{content}</div>
  ) : (
    <Modal
      isOpen={isOpen}
      onClose={onClose}
