...
export const AdminHeader: FC<AdminHeaderProps> = ({ currentUser }) => {
  ...
  return (
    <header className="mb-6 flex flex-col items-center gap-4 border-b border-slate-800/80 pb-5 text-center">
